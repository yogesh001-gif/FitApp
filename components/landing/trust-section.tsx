...
export function TrustSection() {
  return (
    <section className="border-y border-white/5 bg-slate-950/50 backdrop-blur">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-white/10">
          ...
          >
            ...
            <p className="text-3xl font-semibold text-white">10,000+</p>
            <p className="text-sm text-slate-400 mt-1">Workouts Logged</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-3xl font-semibold text-white">Gemini AI</p>
            <p className="text-sm text-slate-400 mt-1">Powered by Google</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-slate-400 mt-1">Secure Cloud Uptime</p>
          </motion.div>
